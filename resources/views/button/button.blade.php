        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="{{$domain->name}}" value="{{$domain->name}}" disabled>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="id">VPS ID:</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="{{$domain->vpsid}}" value="{{$domain->vpsid}}" disabled>
              </div>
            </div>
